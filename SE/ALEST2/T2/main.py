...
OFFSET: int = 1
VALUES: (str, int) = (
    ('data/caso1_cohen.txt', 100),
    ('data/caso2_cohen.txt', 200),
    ('data/caso3_cohen.txt', 500),
    ('data/caso4_cohen.txt', 1000),
    ('data/caso5_cohen.txt', 2000),
    ('data/caso6_cohen.txt', 5000),
    ('data/caso7_cohen.txt', 20000),
)
